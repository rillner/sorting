/*
 * SelectionSortWithArrayTest.java
 *
...
public class SelectionSortWithArrayTest extends AbstractSortingTest
{
    ...
    public void alreadySortedSuccess()
    {
        ...
        Integer[] output = SortingUtils.selectionSort(integerComparator, input);
    ...
    public void legalNullElementsSuccess()
    {
        ...
        Integer[] output = SortingUtils.selectionSort(integerComparatorPermittingNull, input);
